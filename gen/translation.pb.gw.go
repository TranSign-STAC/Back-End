...
var (
	filter_TranslationHistory_RemoveHistory_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_TranslationHistory_RemoveHistory_0(ctx context.Context, marshaler runtime.Marshaler, client TranslationHistoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UUIDMessage
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TranslationHistory_RemoveHistory_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.RemoveHistory(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TranslationHistory_RemoveHistory_0(ctx context.Context, marshaler runtime.Marshaler, server TranslationHistoryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UUIDMessage
	var metadata runtime.ServerMetadata
	...
	msg, err := server.RemoveHistory(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTranslationHistoryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TranslationHistoryServer) error {
	...
	mux.Handle("DELETE", pattern_TranslationHistory_RemoveHistory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/transign.TranslationHistory/RemoveHistory")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TranslationHistory_RemoveHistory_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_TranslationHistory_RemoveHistory_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTranslationHistoryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TranslationHistoryClient) error {
	...
	mux.Handle("DELETE", pattern_TranslationHistory_RemoveHistory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/transign.TranslationHistory/RemoveHistory")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TranslationHistory_RemoveHistory_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_TranslationHistory_RemoveHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"translate", "history"}, ""))
)

var (
	forward_TranslationHistory_GetHistory_0 = runtime.ForwardResponseMessage

	forward_TranslationHistory_RemoveHistory_0 = runtime.ForwardResponseMessage
)
